...
import { Button, CardBooking, Header, Icon, ModalFilter, ProductCard1, SafeAreaView, TextInput } from '@/components';
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              <ProductCard1
                ...
                onDelete={() => setProducts(products.filter((product) => product.id !== item.id))}
